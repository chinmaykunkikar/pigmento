...
export function Toggle({ label, on, className, ...props }: Props) {
  return (
    <button
      ...
      className={cn(
        "inline-flex h-7 items-center gap-1.5 rounded-sm border px-2.5 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40",
        on
